# MicroNotes - Microservices Note-Taking Application
...
MicroNotes follows a microservices architecture pattern with the following services:
...
```bash
git clone https://github.com/Tahsin005/micro-notes.git
cd micro-notes
```
