...
export const getProfile = asyncHandler(async (req: Request, res: Response) => {
    ...
    return res.status(200).json(createSuccessResponse(user, "User profile retrieved"));
});
...
export const deleteAccount = asyncHandler(
    async (req: Request, res: Response) => {
        ...
        return res.status(200).json(createSuccessResponse(null, "Account deleted successfully"));
    }
);
