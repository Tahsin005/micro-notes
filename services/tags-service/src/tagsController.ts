...
export const createTag = asyncHandler(async (req: Request, res: Response) => {
    ...
    return res.status(201).json(createSuccessResponse(tag, "Tag created successfully"));
});
...
export const getTagById = asyncHandler(async (req: Request, res: Response) => {
    ...
    return res.status(200).json(createSuccessResponse(tag, "Tag retrieved successfully"));
});
